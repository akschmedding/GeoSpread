...
public class CovidSimulationWorstWithUI extends GUIState
{
    ...
    protected CovidSimulationWorstWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationWorstWithUI simple = new CovidSimulationWorstWithUI(new CovidSimulationWorst(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationWorst world = (CovidSimulationWorst) state;
