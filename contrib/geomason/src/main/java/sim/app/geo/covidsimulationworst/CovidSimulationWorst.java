 ...
 * push it up.
 */
public class CovidSimulationWorst extends SimState
{
    ...
    {
        doLoop(CovidSimulationWorst.class, args);
        System.exit(0);
    }
...
//    ArrayList<Double> yAxisMobility = new ArrayList<>();
     ...
     * Constructor
     */
    public CovidSimulationWorst(long seed)
    {
        super(seed);
    }
...
//            URL areasDB = Paths.get("data","building_demo.dbf").toUri().toURL() ;
            ...
            Steppable flipper = new Steppable()
            {
                ...
                public void step(SimState state)
                {
                	...
                	CovidSimulationWorst gstate = (CovidSimulationWorst) state;
        ...
        {
            Logger.getLogger(CovidSimulationWorst.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex)
        {
            Logger.getLogger(CovidSimulationWorst.class.getName()).log(Level.SEVERE, null, ex);
        }
