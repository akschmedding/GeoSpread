 ...
 * $Id$
 */
package sim.app.geo.covidsimulationworst;
...
//    }
    ...
    public Agent(CovidSimulationWorst g, 
     ...
     */
    public boolean start(CovidSimulationWorst state)
    {
    ...
    private boolean findNewAStarPath(CovidSimulationWorst geoTest)
    {
