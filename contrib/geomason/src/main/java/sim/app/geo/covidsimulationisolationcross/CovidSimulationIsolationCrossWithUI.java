...
public class CovidSimulationIsolationCrossWithUI extends GUIState
{
    ...
    protected CovidSimulationIsolationCrossWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationIsolationCrossWithUI simple = new CovidSimulationIsolationCrossWithUI(new CovidSimulationIsolationCross(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationIsolationCross world = (CovidSimulationIsolationCross) state;
