...
import sim.app.geo.covidsimulationvaccination.Agent;
 ...
 * push it up.
 */
public class CovidSimulationVaccination extends SimState {
    ...
    public static void main(String[] args) {
        doLoop(CovidSimulationVaccination.class, args);
        System.exit(0);
    }
    ...
    public double pct_vaccinated = 0.0;
    public double effective_vaccine = 1.0;
     ...
     * Constructor
     */
    public CovidSimulationVaccination(long seed) {
        super(seed);
    }
    ...
    public void start() {
        ...
        try {
        	...
        	pct_vaccinated=s.nextDouble();
        	effective_vaccine=s.nextDouble();
        	s.close();
            ...
            Steppable flipper = new Steppable()
            {
                ...
                public void step(SimState state) {
                	...
                	CovidSimulationVaccination gstate = (CovidSimulationVaccination) state;
            ...
            Logger.getLogger(CovidSimulationVaccination.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(CovidSimulationVaccination.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    	...
    	if (curAgents.get(0).atHome) { //infection at home
    		...
    		for (ArrayList<Agent> f: families) {
        		...
        		for (int i = 0; i < infected; i++) {
        			pr_infection = (1-infect_probability*(1-effective_vaccine)) * pr_infection;
        		}
    ...
    public void populate() {
        try {
        	...
        	for (int i = 0; i < population; i++) {
                ...
                if (ThreadLocalRandom.current().nextDouble() <pct_vaccinated) {
                	a.setVaccinated();
                }
