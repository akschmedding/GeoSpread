...
import sim.app.geo.covidsimulationarea_noroads.Agent;
 ...
 * push it up.
 */
public class CovidSimulationAreaNoRoads extends SimState {
    ...
    public static void main(String[] args) {
        doLoop(CovidSimulationAreaNoRoads.class, args);
        System.exit(0);
    }
     ...
     * Constructor
     */
    public CovidSimulationAreaNoRoads(long seed) {
        super(seed);
    }
        ...
        try {
            ...
            Steppable flipper = new Steppable()
            {
                ...
                public void step(SimState state) {
                	...
                	CovidSimulationAreaNoRoads gstate = (CovidSimulationAreaNoRoads) state;
            ...
            Logger.getLogger(CovidSimulationAreaNoRoads.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(CovidSimulationAreaNoRoads.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
