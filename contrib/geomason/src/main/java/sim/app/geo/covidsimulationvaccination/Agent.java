 ...
 * $Id$
 */
package sim.app.geo.covidsimulationvaccination;
...
public final class Agent implements Steppable {
    ...
    CovidSimulationVaccination world;
    ...
    public Agent(CovidSimulationVaccination g) {
        world = g;
     ...
     */
    public boolean start(CovidSimulationVaccination state) {
    ...
    public void step(SimState state) {
    	if (inBuilding == true) {
    		...
    		if (mv_cycle > 0) {
    			...
    			stay_cycle = (int) Math.ceil(sampleFromDistr(xActivityLength, yActivityLength)*60.0/5.0/world.caution_factor); //5min cycles
    			cur_stay_cycle = stay_cycle;
    			//System.out.println(stay_cycle);
