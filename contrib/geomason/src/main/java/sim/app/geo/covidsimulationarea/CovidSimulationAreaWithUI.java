...
public class CovidSimulationAreaWithUI extends GUIState
{
    ...
    protected CovidSimulationAreaWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationAreaWithUI simple = new CovidSimulationAreaWithUI(new CovidSimulationArea(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationArea world = (CovidSimulationArea) state;
