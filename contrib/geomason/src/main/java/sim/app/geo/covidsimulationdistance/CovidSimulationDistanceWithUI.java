...
public class CovidSimulationDistanceWithUI extends GUIState
{
    ...
    protected CovidSimulationDistanceWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationDistanceWithUI simple = new CovidSimulationDistanceWithUI(new CovidSimulationDistance(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationDistance world = (CovidSimulationDistance) state;
