...
public class CovidSimulationVaccinationWithUI extends GUIState
{
    ...
    protected CovidSimulationVaccinationWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationVaccinationWithUI simple = new CovidSimulationVaccinationWithUI(new CovidSimulationVaccination(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationVaccination world = (CovidSimulationVaccination) state;
