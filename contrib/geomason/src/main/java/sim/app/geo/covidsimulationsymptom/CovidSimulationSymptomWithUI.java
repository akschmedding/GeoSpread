...
public class CovidSimulationSymptomWithUI extends GUIState
{
    ...
    protected CovidSimulationSymptomWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationSymptomWithUI simple = new CovidSimulationSymptomWithUI(new CovidSimulationSymptom(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationSymptom world = (CovidSimulationSymptom) state;
