...
public class CovidSimulationAreaNoRoadsWithUI extends GUIState
{
    ...
    protected CovidSimulationAreaNoRoadsWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationAreaNoRoadsWithUI simple = new CovidSimulationAreaNoRoadsWithUI(new CovidSimulationAreaNoRoads(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationAreaNoRoads world = (CovidSimulationAreaNoRoads) state;
