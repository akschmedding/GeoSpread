...
public class CovidSimulationAreaIsolationWithUI extends GUIState
{
    ...
    protected CovidSimulationAreaIsolationWithUI(SimState state)
    {
        super(state);
    }
    ...
    {
    	CovidSimulationAreaIsolationWithUI simple = new CovidSimulationAreaIsolationWithUI(new CovidSimulationAreaIsolation(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        CovidSimulationAreaIsolation world = (CovidSimulationAreaIsolation) state;
