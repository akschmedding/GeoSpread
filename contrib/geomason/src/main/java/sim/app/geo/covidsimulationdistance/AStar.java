...
public class AStar
{
    ...
    public ArrayList<GeomPlanarGraphDirectedEdge> astarPath(Node start, Node goal)
    {
        ...
        { // while there are reachable nodes to investigate
            ...
            closedSet.add(x);
//            System.out.println("in astr first loop " +openSet.size() + " "+ closedSet.size() + " "+ result.size() + x.node.getCoordinate());
            ...
            for (Object o : des.getEdges().toArray())
            {
                ...
                Node next = null;
                next = l.getToNode();
//                System.out.println("in astr " +openSet.size() + " "+ closedSet.size() + " "+ result.size() + next.getCoordinate());
...
//                System.out.println("in astr " +openSet.size() + " "+ closedSet.size() + " "+ result.size());
            }
//            System.out.println("in astr first loop " +openSet.size() + " "+ closedSet.size() + " "+ result.size());
        }
